...
{
    internal class RequesterInputDefinitionProcessor : InputDefinitionProcessor<RequesterInputDefinitionProcessor.InputDefinition>
    {
        public override bool CanProcess(SyntaxNode syntaxNode)
        {
            ...
            return typeDeclarationSyntax.AttributeLists
                ...
                .Any(attribute => attribute.Name.ToString() == "BluQubeRequester");
        }
