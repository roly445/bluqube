...
/// <summary>
/// Dispatches commands to their handlers via the Mediator pipeline with automatic authorization exception handling.
/// </summary>
/// <remarks>
/// This class wraps Mediator's <c>IMediator</c> to provide command execution. It automatically catches <c>UnauthorizedException</c> thrown by the BluQube authorization behavior
...
/// </para>
/// </remarks>
public class CommandRunner(IMediator mediator) : ICommandRunner
{
    /// <inheritdoc/>
