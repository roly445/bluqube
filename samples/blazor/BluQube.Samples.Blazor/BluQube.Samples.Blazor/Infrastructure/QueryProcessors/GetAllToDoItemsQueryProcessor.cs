...
{
    public ValueTask<QueryResult<GetAllToDoItemsQueryAnswer>> Handle(GetAllToDoItemsQuery request, CancellationToken cancellationToken)
    {
        ...
        return ValueTask.FromResult(QueryResult<GetAllToDoItemsQueryAnswer>.Succeeded(result));
    }
}